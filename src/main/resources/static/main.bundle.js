...
var TransportComponent = (function (_super) {
    ...
    function TransportComponent(transportService, router) {
        ...
        _this._availableTransportTypes = [
            ...
            { value: __WEBPACK_IMPORTED_MODULE_3__service_transport_service_transport_service__["a" /* TransportService */].TRANSPORT_TYPE_TROLLEYBUS, viewValue: 'TROLLEYBUS' }
        ];
        _this._availableTransportFunctionality = [
            { value: __WEBPACK_IMPORTED_MODULE_3__service_transport_service_transport_service__["a" /* TransportService */].TRANSPORT_FUNCTIONALITY_WORKING, viewValue: "FUNCTIONALLY" },
            { value: __WEBPACK_IMPORTED_MODULE_3__service_transport_service_transport_service__["a" /* TransportService */].TRANSPORT_FUNCTIONALITY_BROKEN, viewValue: "NO FUNCTIONALLY" }
        ];
    ...
    Object.defineProperty(TransportComponent.prototype, "availableTransportTypes", {
        get: function () {
            return this._availableTransportTypes;
        },
        set: function (value) {
    ...
    Object.defineProperty(TransportComponent.prototype, "availableTransportFunctionality", {
        get: function () {
    ...
    Object.defineProperty(TransportComponent.prototype, "error", {
        get: function () {
            return this._error;
        },
        set: function (value) {
    ...
    Object.defineProperty(TransportComponent.prototype, "transportInfo", {
        get: function () {
            return this._transportInfo;
        },
        set: function (value) {
...
var TransportParams = (function () {
    function TransportParams(transportType, registrationNumber, functionality) {
