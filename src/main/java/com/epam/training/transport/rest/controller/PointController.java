...
import static com.epam.training.transport.utils.routes.Routes.API_POINTS;
...
public class PointController {
    ...
    public PointEntity create(@Valid
                              @RequestBody final PointModel pointModel) {
    ...
    @ResponseBody
    public PointEntity update(@PathVariable final long id, @RequestBody
    @Valid final PointModel model) {
    ...
    public List<PointEntity> loadAll(@ApiParam(value = "Search point by same symbols")
                                     @RequestParam(required = false) final String likeChars) {
